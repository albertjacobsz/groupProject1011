...
courseInfo info[81];//CS for Computer Science
...
//test
for (int i = 45; i<56;i++){
    cout << setw(15) << "Level: " << info[i].level << endl;
    cout << setw(15) << "Code: " << info[i].subCode << endl;
    cout << setw(15) << "Title: " << info[i].subTitle << endl;
    cout << setw(15) << "Credit: " << info[i].credit << endl;
    for(int j=0; j<5;j++){
    cout << setw(15) << "Pre-Req: " << info[i].preReq[j] << endl;
    }
    cout << setw(15) << "lecture: " << info[i].lecture << endl;
}
